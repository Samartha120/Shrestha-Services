...
export const getMockDb = () => {
    ...
    return {
        services: getOrInit("ss_services", DEFAULT_SERVICES),
        projects: getOrInit("ss_projects", DEFAULT_PROJECTS),
        gallery: getOrInit("ss_gallery", DEFAULT_GALLERY),
        testimonials: getOrInit("ss_testimonials", DEFAULT_TESTIMONIALS),
        inquiries: getOrInit("ss_inquiries", DEFAULT_INQUIRIES),
        users: getOrInit("ss_users", DEFAULT_USERS),
        quotes: getOrInit("ss_quotes", DEFAULT_QUOTES),
        orders: getOrInit("ss_orders", DEFAULT_ORDERS),
        notifications: getOrInit("ss_notifications", DEFAULT_NOTIFICATIONS),
    };
};
export const updateMockDb = (key, data) => {
