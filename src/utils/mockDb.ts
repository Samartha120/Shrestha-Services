...
const DEFAULT_GALLERY: GalleryItem[] = [
  ...
  { id: "g7", title: "Corporate Brochure Design", image: "https://images.unsplash.com/photo-1586075010923-2dd4570fb338?auto=format&fit=crop&w=800&q=80", category: "Branding & Advertising Solutions", description: "Full color A4 tri-fold brochures with premium matte finish." },
  { id: "g8", title: "Vinyl Stickers Sheet", image: "https://images.unsplash.com/photo-1575367440625-8a0b064e23c8?auto=format&fit=crop&w=800&q=80", category: "Digital & Custom Decals", description: "Custom die-cut vinyl stickers for product labeling and promotions." },
  { id: "g9", title: "Outdoor Billboard Installation", image: "https://images.unsplash.com/photo-1540959733332-eab4deceeaf7?auto=format&fit=crop&w=800&q=80", category: "Signage & Boards", description: "Highway billboard with weather-resistant UV printed flex." },
  { id: "g10", title: "Restaurant Menu Board", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80", category: "Signage & Boards", description: "LED backlit menu boards with changeable inserts." },
  { id: "g11", title: "Exhibition Roll-Up Stand", image: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=800&q=80", category: "Flex & Banner Printing", description: "Portable roll-up banner stand for trade shows and exhibitions." },
  { id: "g12", title: "Office Glass Partition Branding", image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80", category: "Digital & Custom Decals", description: "Custom printed frosted glass film with company branding." },
  { id: "g13", title: "Premium Envelope Printing", image: "https://images.unsplash.com/photo-1586717799252-bd039a44986c?auto=format&fit=crop&w=800&q=80", category: "Branding & Advertising Solutions", description: "Custom printed corporate envelopes with logo and branding." },
  { id: "g14", title: "3D Lettering Signage", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80", category: "Signage & Boards", description: "Premium 3D raised lettering for corporate building facades." },
  { id: "g15", title: "Event Banner for Conference", image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=800&q=80", category: "Flex & Banner Printing", description: "Large format conference backdrop with step-and-repeat logos." }
];
